...
if __name__ == '__main__':
    ...
    stations_1b_df = pd.read_csv("results/stations_1b.csv", index_col='station_id')
    allocations_1b_df = pd.read_csv("results/allocations_1b.csv", index_col='robot_id')
    ...
    stations_out_path = "results/stations_1c.csv"
    allocations_out_path = "results/allocations_1c.csv"
